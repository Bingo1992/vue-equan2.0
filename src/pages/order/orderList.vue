<template>
	<div>	
		...
		<ul class="border-list" v-if="orderList.length">
			<li class="bg-mgShow" v-for="(item, i) in orderList">
	            ...
	            <!-- 已支付订单 -->
				<div class="list-box border-bottom" v-if="item.detail" v-for="(pro, i) in item.detail" :key="pro.id">
	           ...
	           <!--  <div  v-if="item.detail" class="flex-right">
	            ...
	            <!-- 未支付订单 -->
				<div v-if="item.unpaid" class="list-box border-bottom" v-for="(pro, i) in item.unpaid" :key="pro.id">
	            ...
	            <div  v-if="item.unpaid" class="flex-right border-top">
	            	<a class="btn-delete btn-border">取消订单</a>
